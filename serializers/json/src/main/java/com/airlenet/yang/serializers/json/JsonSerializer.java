...
import com.airlenet.yang.runtime.DefaultCompositeData;
import com.airlenet.yang.runtime.DefaultCompositeStream;
...
import static com.airlenet.yang.serializers.json.DecoderUtils.convertJsonToDataNode;
import static com.airlenet.yang.serializers.utils.SerializersUtil.convertRidToUri;
import static com.airlenet.yang.serializers.utils.SerializersUtil.convertUriToRid;
...
public class JsonSerializer implements YangSerializer {
    ...
    public CompositeData decode(CompositeStream compositeStream,
        ...
        try {
             ...
             */
            if (rIdBuilder != null) {
                dataNode = DecoderUtils.convertJsonToDataNode(rootNode,
                                                 rIdBuilder);
    ...
    public CompositeStream encode(CompositeData compositeData,
        ...
        if (compositeData.resourceData().dataNodes() != null) {
            rootNode = EncoderUtils.convertDataNodeToJson(compositeData.
