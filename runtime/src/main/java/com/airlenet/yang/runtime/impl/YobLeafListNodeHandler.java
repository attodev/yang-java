...
import com.airlenet.yang.compiler.datamodel.javadatamodel.JavaQualifiedTypeInfoContainer;
...
class YobLeafListNodeHandler extends YobHandler {
    ...
    void setInParent(DataNode leafNode,
        ...
        try {
            YangSchemaNode schemaNode = YobUtils.getChildSchemaNode(leafNode,
                                                           curWb.schemaNode());
            ...
            Method setterMethod = parentClass.getDeclaredMethod(
                    YobConstants.ADD_TO + YobUtils.getCapitalCase(setterInParent), genericListClass);
            ...
            YobUtils.setDataFromStringValue(yangType.getDataType(),
