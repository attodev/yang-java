...
import com.airlenet.yang.compiler.datamodel.YangSchemaNodeType;
...
class ModIdToRscIdConverter {
    ...
    ResourceId.Builder fetchResourceId(ModelObjectId id) {
        ...
        return convertToResourceId(id, fetchModuleNode(ModelConverterUtil.fetchPackage(path)),
                                   rid);
    }
    ...
    private ResourceId.Builder convertToResourceId(ModelObjectId id, YangSchemaNode
        ...
        while (it.hasNext()) {
            ...
            try {
                ...
                pkg = ModelConverterUtil.fetchPackage(path);
    ...
    private void handleLeafInRid(YangSchemaNode preNode, ModelObjectId id,
        ...
        if (curNode instanceof YangLeaf) {
            ...
            val = ModelConverterUtil.getObjFromType(preNode, path, curNode, "value", val, type);
    ...
    private Object getKeyValue(Object keys, String keyName) {
        try {
            return ModelConverterUtil.getAttributeOfObject(keys, getCamelCase(keyName, null));
    ...
    private Object getKeyObject(Object keysObj, String key, YangList list) {
        ...
        return ModelConverterUtil.getObjFromType(list, keysObj, leaf, key, keyObj, type);
    }
}
