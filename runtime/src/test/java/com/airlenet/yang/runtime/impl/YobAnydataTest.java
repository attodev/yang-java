...
import com.airlenet.yang.gen.v1.yrtietfnetwork.rev20151208.yrtietfnetwork.networks.network.Node;
import com.airlenet.yang.gen.v1.yrtietfnetwork.rev20151208.yrtietfnetwork.networks.network.node.SupportingNode;
...
public class YobAnydataTest {
    ...
    public DataNode buildDnForAnydata() {
        ...
        value = null;
        // Adding container c1
        dBlr = addDataNode(dBlr, "c1", TestUtils.TANY_NS, value, null);
        // Adding anydata container
        dBlr = addDataNode(dBlr, "mydata2", TestUtils.TANY_NS, value, null);
        ...
        // Adding list inside anydata container
        value = null;
        dBlr = addDataNode(dBlr, "node", TestUtils.IETFNS, value, null);
