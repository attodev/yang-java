...
import com.airlenet.yang.runtime.mockclass.testmodule.testrpc.testinput.DefaultTestContainer;
...
import com.airlenet.yang.gen.v1.check.check.Cont53;
import com.airlenet.yang.gen.v1.check.check.DefaultCont53;
import com.airlenet.yang.gen.v1.check.check.DefaultList56;
import com.airlenet.yang.gen.v1.check.check.List56;
import com.airlenet.yang.gen.v1.check.check.List56Keys;
import com.airlenet.yang.gen.v1.check.check.group1.DefaultCont58;
import com.airlenet.yang.gen.v1.check.check.group1.DefaultList57;
import com.airlenet.yang.gen.v1.check.check.group1.List57Keys;
import com.airlenet.yang.gen.v1.check.check.list56.augmentedlist56.Cont56;
import com.airlenet.yang.gen.v1.check.check.list56.augmentedlist56.DefaultCont56;
import com.airlenet.yang.gen.v1.check.check.list56.cont56.augmentedcont56.DefaultCont57;
...
import com.airlenet.yang.gen.v1.modeldatatoresourcedata.rev20160826.modeldatatoresourcedata.firstlevel.containerleaf.AugmentedContainerLeaf;
...
import com.airlenet.yang.gen.v1.ytbtreebuilderforlisthavinglist.rev20160826.ytbtreebuilderforlisthavinglist.carrier.MultiplexesKeys;
import com.airlenet.yang.gen.v1.ytbtreebuilderforlisthavinglist.rev20160826.ytbtreebuilderforlisthavinglist.carrier.multiplexes.ApplicationAreasKeys;
...
import static com.airlenet.yang.gen.v1.ytbtreebuilderforlisthavinglist.rev20160826.ytbtreebuilderforlisthavinglist.carrier.multiplexes.TypesEnum.SPACE_DIVISION;
import static com.airlenet.yang.runtime.impl.MockYangSchemaNodeProvider.addMockNode;
...
public class MoIdToRscIdTest {
    ...
    public void moIdWithInputAndContainer() {
        ...
        mid = new ModelObjectId.Builder()
                ...
                .addChild(DefaultTestContainer.class)
                .build();
    ...
    public void moIdWithNotificationAndContainer() {
        ...
        mid = new ModelObjectId.Builder()
                ...
                .addChild(com.airlenet.yang.runtime.mockclass.testmodule.testnotification.DefaultTestContainer.class).build();
    ...
    private YangNode getModuleWithRpc() throws DataModelException {
        ...
        rpc.addChild(in);
        try {
            in.addChild(getMockContainer("com.airlenet.yang.runtime.mockclass" +
                                                 ".testmodule.testrpc" +
                                                 ".testinput"));
        } catch (DataModelException e) {
            log.info("test error");
    ...
    private YangNode getModuleWithNotification() throws DataModelException {
        ...
        mod.addChild(not);
        try {
            not.addChild(getMockContainer("com.airlenet.yang.runtime" +
    ...
    private YangModule getYangModule() {
        YangModule mod = new YangModule() {
            ...
            public String getJavaPackage() {
                return "com.airlenet.yang.runtime.mockclass";
            }
    ...
    private YangRpc getRpcNode() {
        YangRpc rpc = new YangRpc() {
            @Override
            public String getJavaPackage() {
                return "com.airlenet.yang.runtime.mockclass.testmodule";
            }
    ...
    private YangOutput getOutputNode() {
        ...
        YangOutput out = new YangOutput() {
            @Override
            public String getJavaPackage() {
                return "com.airlenet.yang.runtime" +
