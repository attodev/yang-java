...
import com.airlenet.yang.gen.v1.actnietftetypes.rev20170310.actnietftetypes.LspEncodingOduk;
import com.airlenet.yang.gen.v1.actnietftetypes.rev20170310.actnietftetypes.LspProtUnprotected;
import com.airlenet.yang.gen.v1.actnietftetypes.rev20170310.actnietftetypes.PathSignalingRsvpte;
import com.airlenet.yang.gen.v1.actnietftetypes.rev20170310.actnietftetypes.StateUp;
import com.airlenet.yang.gen.v1.actnietftetypes.rev20170310.actnietftetypes.TeGlobalId;
import com.airlenet.yang.gen.v1.actnietftetypes.rev20170310.actnietftetypes.TeTopologyId;
import com.airlenet.yang.gen.v1.actnietftetypes.rev20170310.actnietftetypes.TunnelP2p;
import com.airlenet.yang.gen.v1.yrtietfinettypes.rev20130715.yrtietfinettypes.IpAddress;
import com.airlenet.yang.gen.v1.yrtietfinettypes.rev20130715.yrtietfinettypes.Ipv4Address;
import com.airlenet.yang.gen.v1.yrtietfinettypes.rev20130715.yrtietfinettypes.ipaddress.IpAddressUnion;
import com.airlenet.yang.gen.v1.yrtietftemplstypes.rev20170310.yrtietftemplstypes.BandwidthKbps;
import com.airlenet.yang.gen.v1.yrtietftemplstypes.rev20170310.yrtietftemplstypes.TeBandwidthType;
import com.airlenet.yang.gen.v1.yrtietftransporttypes.rev20161025.yrtietftransporttypes.ClientSignal10GbElan;
import com.airlenet.yang.gen.v1.yrtietftransporttypes.rev20161025.yrtietftransporttypes.ClientSignalOdu2e;
import com.airlenet.yang.gen.v1.yrtietfyangtypes.rev20130715.yrtietfyangtypes.DateAndTime;
import com.airlenet.yang.gen.v1.yrtietfyangtypes.rev20130715.yrtietfyangtypes.Xpath10;
import com.airlenet.yang.gen.v11.actnietfschedule.rev20170306.actnietfschedule.DefaultConfigurationSchedules;
import com.airlenet.yang.gen.v11.actnietfschedule.rev20170306.actnietfschedule.Operation;
import com.airlenet.yang.gen.v11.actnietfschedule.rev20170306.actnietfschedule.configurationschedules.DefaultTarget;
import com.airlenet.yang.gen.v11.actnietfschedule.rev20170306.actnietfschedule.configurationschedules.target.DefaultDataValue;
import com.airlenet.yang.gen.v11.actnietfschedule.rev20170306.actnietfschedule.schedules.DefaultSchedules;
import com.airlenet.yang.gen.v11.actnietfschedule.rev20170306.actnietfschedule.schedules.schedules.DefaultSchedule;
import com.airlenet.yang.gen.v11.actnietfte.rev20170310.actnietfte.DefaultTe;
import com.airlenet.yang.gen.v11.actnietfte.rev20170310.actnietfte.tetunnelbandwidthtop.Bandwidth;
import com.airlenet.yang.gen.v11.actnietfte.rev20170310.actnietfte.tetunnelbandwidthtop.DefaultBandwidth;
import com.airlenet.yang.gen.v11.actnietfte.rev20170310.actnietfte.tunnelp2pproperties.DefaultConfig;
import com.airlenet.yang.gen.v11.actnietfte.rev20170310.actnietfte.tunnelp2pproperties.DefaultP2PprimaryPaths;
import com.airlenet.yang.gen.v11.actnietfte.rev20170310.actnietfte.tunnelp2pproperties.p2pprimarypaths.DefaultP2PprimaryPath;
import com.airlenet.yang.gen.v11.actnietfte.rev20170310.actnietfte.tunnelsgrouping.DefaultTunnels;
import com.airlenet.yang.gen.v11.actnietfte.rev20170310.actnietfte.tunnelsgrouping.tunnels.DefaultTunnel;
import com.airlenet.yang.gen.v11.yrtietfotntunnel.rev20170311.yrtietfotntunnel.otntunnelendpoint.DefaultDstTributarySlots;
import com.airlenet.yang.gen.v11.yrtietfotntunnel.rev20170311.yrtietfotntunnel.otntunnelendpoint.DefaultSrcTributarySlots;
import com.airlenet.yang.gen.v11.yrtietfotntunnel.rev20170311.yrtietfotntunnel.te.tunnels.tunnel.config.DefaultAugmentedTeConfig;
...
import static com.airlenet.yang.gen.v1.yrtietftemplstypes.rev20170310.yrtietftemplstypes.tebandwidthtype.TeBandwidthTypeEnum.SPECIFIED;
import static com.airlenet.yang.gen.v11.actnietfschedule.rev20170306.actnietfschedule.operation.OperationEnum.CONFIGURE;
import static com.airlenet.yang.gen.v11.yrtietfotntunnel.rev20170311.yrtietfotntunnel.otntunnelendpoint.PayloadTreatmentEnum.TRANSPORT;
...
import static com.airlenet.yang.runtime.impl.TestUtils.ACTN_SCHD_NS;
import static com.airlenet.yang.runtime.impl.TestUtils.ACTN_TE;
import static com.airlenet.yang.runtime.impl.TestUtils.OTN_TUNN;
import static com.airlenet.yang.runtime.impl.TestUtils.validateDataNode;
import static com.airlenet.yang.runtime.impl.TestUtils.validateLeafDataNode;
import static com.airlenet.yang.runtime.impl.TestUtils.walkINTree;
...
public class YtbAtcnAnydataTest {
    ...
    public void processAnydataTest() {
        ...
        com.airlenet.yang.gen.v11.actnietfte.rev20170310.actnietfte
                .tetunnelbandwidthtop.bandwidth.DefaultConfig confg = new com
                .airlenet.yang.gen.v11.actnietfte.rev20170310
        ...
        com.airlenet.yang.gen.v11.actnietfte.rev20170310.actnietfte
                ...
                new com.airlenet.yang.gen.v11.actnietfte.rev20170310
