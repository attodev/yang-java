...
import com.airlenet.yang.gen.v1.hello.rev20150105.hello.hellosecond.DefaultHelloSecondInput;
import com.airlenet.yang.gen.v1.hello.rev20150105.hello.hellosecond.HelloSecondInput;
import com.airlenet.yang.gen.v1.hello.rev20150105.hello.hellosecond.HelloSecondOutput;
import com.airlenet.yang.gen.v1.hello.rev20150105.hello.helloworld.DefaultHelloWorldInput;
import com.airlenet.yang.gen.v1.hello.rev20150105.hello.helloworld.HelloWorldInput;
import com.airlenet.yang.model.DataNode.Type;
...
import com.airlenet.yang.model.ModelConverter;
...
import com.airlenet.yang.model.RpcContext;
...
public class RpcContextTest {
    ...
    public void checkRpcContext() {
        ...
        assertEquals(context.serviceIntf().toString(), "interface com.airlenet" +
