...
import com.airlenet.yang.runtime.mockclass.testmodule.DefaultTestNotification;
import com.airlenet.yang.runtime.mockclass.testmodule.testnotification.DefaultTestContainer;
import com.airlenet.yang.runtime.mockclass.testmodule.testrpc.DefaultTestInput;
import com.airlenet.yang.runtime.mockclass.testmodule.testrpc.DefaultTestOutput;
import org.junit.Before;
import org.junit.Rule;
import org.junit.Test;
import org.junit.rules.ExpectedException;
import com.airlenet.yang.gen.v1.modulelistandkey.rev20160826.modulelistandkey.DefaultModKey;
import com.airlenet.yang.gen.v1.modulelistandkey.rev20160826.modulelistandkey.ModKey;
import com.airlenet.yang.gen.v1.modulelistandkey.rev20160826.modulelistandkey.ModKeyKeys;
...
import com.airlenet.yang.gen.v1.yrtietfte.rev20170310.yrtietfte.DefaultTe;
import com.airlenet.yang.gen.v1.yrtietfte.rev20170310.yrtietfte.tunnelp2pproperties.DefaultState;
import com.airlenet.yang.gen.v1.yrtietfte.rev20170310.yrtietfte.tunnelsgrouping.DefaultTunnels;
import com.airlenet.yang.gen.v1.yrtietfte.rev20170310.yrtietfte.tunnelsgrouping.tunnels.DefaultTunnel;
import com.airlenet.yang.gen.v1.yrtietftetypes.rev20160320.yrtietftetypes.TunnelP2p;
import com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.ytbdatatypes.Cont1;
...
import com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.ytbdatatypes.Def6;
import com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.ytbdatatypes.Def7;
import com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.ytbdatatypes.DefaultCont1;
...
import com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.ytbdatatypes.cont1.Cont2;
import com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.ytbdatatypes.cont1.DefaultCont2;
import com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.ytbdatatypes.cont1.cont2.AugmentedCont2;
import com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.ytbdatatypes.cont1.cont2.DefaultAugmentedCont2;
import com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.ytbdatatypes.def1.Def1Union;
import com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.ytbdatatypes.def7.Def7Union;
import com.airlenet.yang.gen.v1.ytbietfschedule.rev20160826.YtbIetfSchedule;
import com.airlenet.yang.gen.v1.ytbietfschedule.rev20160826.ytbietfschedule.Enum1Enum;
import com.airlenet.yang.gen.v1.ytbietfschedule.rev20160826.ytbietfschedule.Enum2Enum;
import com.airlenet.yang.gen.v1.ytbmodulewithcontainer.rev20160826.ytbmodulewithcontainer.DefaultSched;
import com.airlenet.yang.gen.v1.ytbmodulewithleaflist.rev20160826.YtbModuleWithLeafList;
import com.airlenet.yang.gen.v1.ytbrpc.rev20160826.ytbrpc.content.DefaultContentInput;
import com.airlenet.yang.gen.v1.ytbrpc.rev20160826.ytbrpc.content.DefaultContentOutput;
import com.airlenet.yang.gen.v1.ytbrpc.rev20160826.ytbrpc.content.contentinput.DefaultIn;
import com.airlenet.yang.gen.v1.ytbrpc.rev20160826.ytbrpc.content.contentinput.InTypedef;
import com.airlenet.yang.gen.v1.ytbrpc.rev20160826.ytbrpc.content.contentoutput.outch.DefaultFirst;
import com.airlenet.yang.gen.v1.ytbtreebuilderforlisthavinglist.rev20160826.ytbtreebuilderforlisthavinglist.DefaultCarrier;
import com.airlenet.yang.gen.v1.ytbtreebuilderforlisthavinglist.rev20160826.ytbtreebuilderforlisthavinglist.carrier.DefaultMultiplexes;
import com.airlenet.yang.gen.v1.ytbtreebuilderforlisthavinglist.rev20160826.ytbtreebuilderforlisthavinglist.carrier.Multiplexes;
import com.airlenet.yang.gen.v1.ytbtreebuilderforlisthavinglist.rev20160826.ytbtreebuilderforlisthavinglist.carrier.multiplexes.ApplicationAreas;
import com.airlenet.yang.gen.v1.ytbtreebuilderforlisthavinglist.rev20160826.ytbtreebuilderforlisthavinglist.carrier.multiplexes.DefaultApplicationAreas;
import com.airlenet.yang.gen.v1.ytbtreebuilderforlisthavinglist.rev20160826.ytbtreebuilderforlisthavinglist.carrier.multiplexes.TypesEnum;
import com.airlenet.yang.model.DataNode;
import com.airlenet.yang.model.DefaultModelObjectData.Builder;
import com.airlenet.yang.model.InnerModelObject;
import com.airlenet.yang.model.InnerNode;
import com.airlenet.yang.model.KeyLeaf;
import com.airlenet.yang.model.LeafIdentifier;
import com.airlenet.yang.model.LeafListKey;
import com.airlenet.yang.model.LeafModelObject;
...
import static com.airlenet.yang.gen.v1.simpledatatypes.rev20131112.simpledatatypes.Cont.LeafIdentifier.LFENUM1;
import static com.airlenet.yang.gen.v1.simpledatatypes.rev20131112.simpledatatypes.tpdfun0.Tpdfun0Enum.SUCCESSFUL_EXIT;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LEAF1;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LEAF10;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LEAF11;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LEAF12;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LEAF13;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LEAF14;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LEAF2;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LEAF3;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LEAF4;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LEAF5;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LEAF6;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LEAF7;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LEAF8;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LEAF9;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LL1;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LL10;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LL11;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LL12;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LL13;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LL14;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LL15;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LL2;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LL3;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LL4;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LL5;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LL6;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LL7;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LL8;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.YtbDataTypes.LeafIdentifier.LL9;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.ytbdatatypes.Cont1.LeafIdentifier.LEAF15;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.ytbdatatypes.Cont1.LeafIdentifier.LEAF16;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.ytbdatatypes.Cont1.LeafIdentifier.LL16;
import static com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.ytbdatatypes.def1.def1union.Def1UnionEnum1.of;
import static com.airlenet.yang.model.DataNode.Type.MULTI_INSTANCE_LEAF_VALUE_NODE;
...
public class DefaultDataTreeBuilderTest {
    ...
    public void processModuleAndLeaf() {
        ...
        TestUtils.validateDataNode(node, "time", nameSpace, SINGLE_INSTANCE_LEAF_VALUE_NODE,
                         true, "9");
    }
    ...
    public void processModuleAndLeafList() {
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "time", nameSpace, MULTI_INSTANCE_LEAF_VALUE_NODE,
                         true, "1");
    ...
    public void processModuleListAndKeyOneIn() {
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "modKey", nameSpace, MULTI_INSTANCE_NODE,
                         true, null);
        ...
        TestUtils.validateDataNode(n.getValue(), "types", nameSpace,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE, true, "1");

        Iterator<KeyLeaf> keyIt = ((ListKey) node.key()).keyLeafs().iterator();

        TestUtils.validateLeafDataNode(keyIt.next(), "types", nameSpace, "1");
    }
    ...
    public void processModuleListAndKey() {
        ...
        TestUtils.validateLeafDataNode(keyIt.next(), "types", nameSpace, "2");
        ...
        TestUtils.validateLeafDataNode(keyIt.next(), "types", nameSpace, "3");
    }
    ...
    public void processModuleListAndKeyListModId() {
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "types", nameSpace,
    ...
    public void processWithTypeEnum() {
        ...
        node = dataNodes.get(1);
        TestUtils.validateDataNode(node, "enum1", nameSpace,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE,
                         true, "hundred");

        node = dataNodes.get(2);
        TestUtils.validateDataNode(node, "enum2", nameSpace,
                         MULTI_INSTANCE_LEAF_VALUE_NODE,
                         true, "hundred-100");

        node = dataNodes.get(3);
        TestUtils.validateDataNode(node, "enum2", nameSpace, MULTI_INSTANCE_LEAF_VALUE_NODE,
                         true, "ten-10");
    ...
    public void processModuleWithContainer() {
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "sched", nameSpace, SINGLE_INSTANCE_NODE,
                         true, null);
        ...
        TestUtils.validateDataNode(n.getValue(), "predict", nameSpace, SINGLE_INSTANCE_LEAF_VALUE_NODE,
                         true, "98989");
    }
    ...
    public void processModuleWithContainerModId() {
        ...
        TestUtils.validateDataNode(node, "predict", nameSpace, SINGLE_INSTANCE_LEAF_VALUE_NODE,
                         true, "98989");
    }
    ...
    public void processTreeBuilderForListHavingList() {
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "carrier", nameSpace,
        ...
        TestUtils.validateDataNode(n.getValue(), "multiplexes", nameSpace,
        ...
        TestUtils.validateLeafDataNode(keyLeaves.get(0), "types", nameSpace,
                             "time-division");
        ...
        n = it.next();
        TestUtils.validateDataNode(n.getValue(), "application-areas", nameSpace,
                         MULTI_INSTANCE_NODE, true, null);
    ...
    public void processNotificationWithContainer() {
        ...
        TestUtils.validateDataNode(node, "test-container", nameSpace,
    ...
    public void processRpcWithInputDataNode() {
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "input", nameSpace,
                         SINGLE_INSTANCE_NODE,
                         true, null);
    }
    ...
    public void processRpcWithOutputDataNode() {
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "output", nameSpace,
                         SINGLE_INSTANCE_NODE,
                         true, null);
    }
    ...
    public void processRpcWithInputModId() {
        ...
        mid = ModelObjectId.builder()
                .addChild(DefaultTestInput.class).build();
        data.identifier(mid);
        data.addModelObject(new com.airlenet.yang.runtime.mockclass.testmodule.testrpc.testinput.DefaultTestContainer());
    ...
    public void processEnumeration() {
        ...
        assertThat(1, is(dataNodes.size()));
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "lfenum1", nameSpace,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE,
    ...
    public void processIdentityRef() {
        ...
        TestUtils.validateDataNode(node, "te", ns, SINGLE_INSTANCE_NODE, true, null);
        ...
        childNode = ((InnerNode) childNode).childNodes().get(key);
        TestUtils.validateDataNode(childNode, "type", ns, SINGLE_INSTANCE_LEAF_VALUE_NODE,
                         false, "tunnel-p2p");
    }
    ...
    public void processRpc() {
        ...
        TestUtils.validateDataNode(node, "input", ns, SINGLE_INSTANCE_NODE, true, null);
        ...
        node = inDn.get(0);
        TestUtils.validateDataNode(node, "output", ns, SINGLE_INSTANCE_NODE, true, null);
    }
    ...
    public void processDataTypesToDataNode() {
        ...
        TestUtils.validateDataNode(cont1, "cont1", ns, SINGLE_INSTANCE_NODE, true, null);
        ...
        TestUtils.validateDataNode(cont2, "cont2", ns, SINGLE_INSTANCE_NODE, true, null);
    ...
    private Iterator<DataNode> validate(Iterator<DataNode> it, String ns) {
        ...
        TestUtils.validateDataNode(it.next(), "leaf1", ns,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE, true, "leaf1");
        TestUtils.validateDataNode(it.next(), "leaf2", ns,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE, true, "thousand");
        TestUtils.validateDataNode(it.next(), "leaf3", ns,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE, true,
                         "MTEwMTE="); //Base 64 encoding of '11011'
        TestUtils.validateDataNode(it.next(), "leaf4", ns,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE, true, "thousand");
        TestUtils.validateDataNode(it.next(), "leaf5", ns,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE, true, "physical");
        TestUtils.validateDataNode(it.next(), "leaf6", ns,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE, true, "/cont1");
        TestUtils.validateDataNode(it.next(), "leaf7", ns,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE, true, "b1 b2");
        TestUtils.validateDataNode(it.next(), "leaf8", ns,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE, true, null);
        TestUtils.validateDataNode(it.next(), "leaf9", ns,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE, true, "b1 b2");
        TestUtils.validateDataNode(it.next(), "leaf11", ns,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE, true, null);
        TestUtils.validateDataNode(it.next(), "leaf12", ns,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE, true,
                        "MTEwMTE="); //Base 64 encoding of '11011'
        TestUtils.validateDataNode(it.next(), "leaf13", ns,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE, true, "*");
        TestUtils.validateDataNode(it.next(), "leaf14", ns,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE, true, "physical");
        TestUtils.validateDataNode(it.next(), "leaf15", ns,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE, true, "physical");
        TestUtils.validateDataNode(it.next(), "leaf16", ns,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE, true, "3.3ms");
        TestUtils.validateDataNode(it.next(), "ll1", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true, "leaf-list1");
        TestUtils.validateDataNode(it.next(), "ll1", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true, "leaf-list1-2");
        TestUtils.validateDataNode(it.next(), "ll2", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true, "thousand");
        TestUtils.validateDataNode(it.next(), "ll2", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true, "ten");
        TestUtils.validateDataNode(it.next(), "ll3", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true,
                         "MTEwMTE="); //Base 64 encoding of '11011'
        TestUtils.validateDataNode(it.next(), "ll3", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true,
                        "MTEwMTEx"); //Base 64 encoding of '110111'
        TestUtils.validateDataNode(it.next(), "ll4", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true, "thousand");
        TestUtils.validateDataNode(it.next(), "ll4", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true, "ten");
        TestUtils.validateDataNode(it.next(), "ll5", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true, "physical");
        TestUtils.validateDataNode(it.next(), "ll5", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true, "virtual");
        TestUtils.validateDataNode(it.next(), "ll6", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true, "/cont1");
        TestUtils.validateDataNode(it.next(), "ll6", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true, "/cont1/cont2");
        TestUtils.validateDataNode(it.next(), "ll7", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true, "b1 b2");
        TestUtils.validateDataNode(it.next(), "ll7", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true, "b1 b2 b3");
        TestUtils.validateDataNode(it.next(), "ll8", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true, null);
        TestUtils.validateDataNode(it.next(), "ll9", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true, "b1 b2");
        TestUtils.validateDataNode(it.next(), "ll9", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true, "b1 b2 b3");
        TestUtils.validateDataNode(it.next(), "ll11", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true, null);
        TestUtils.validateDataNode(it.next(), "ll12", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true,
                         "MTEwMTE="); //Base 64 encoding of '11011'
        TestUtils.validateDataNode(it.next(), "ll12", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true,
                         "MTEwMTEx"); //Base 64 encoding of '110111'
        TestUtils.validateDataNode(it.next(), "ll13", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true, "*");
        TestUtils.validateDataNode(it.next(), "ll14", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true, "physical");
        TestUtils.validateDataNode(it.next(), "ll14", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true, "virtual");
        TestUtils.validateDataNode(it.next(), "ll15", ns,
                         MULTI_INSTANCE_LEAF_VALUE_NODE, true, "physical");
        TestUtils.validateDataNode(it.next(), "ll16", ns,
