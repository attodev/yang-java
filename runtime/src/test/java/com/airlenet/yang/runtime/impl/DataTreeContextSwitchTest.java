...
import com.airlenet.yang.gen.v1.augmentchoice.rev20160826.augmentchoice.PrivateIp;
import com.airlenet.yang.gen.v1.augmentchoice.rev20160826.augmentchoice.contenttest.valid.AugmentedSchValid;
import com.airlenet.yang.gen.v1.augmentchoice.rev20160826.augmentchoice.contenttest.valid.DefaultAugmentedSchValid;
import com.airlenet.yang.gen.v1.augmentchoice.rev20160826.augmentchoice.contenttest.valid.augmentedschvalid.AugCaseModKey;
import com.airlenet.yang.gen.v1.augmentchoice.rev20160826.augmentchoice.contenttest.valid.augmentedschvalid.DefaultAugCaseModKey;
import com.airlenet.yang.gen.v1.augmentchoice.rev20160826.augmentchoice.contenttest.valid.augmentedschvalid.DefaultTestedCont;
import com.airlenet.yang.gen.v1.augmentchoice.rev20160826.augmentchoice.contenttest.valid.augmentedschvalid.DefaultUnlistedVal;
import com.airlenet.yang.gen.v1.augmentchoice.rev20160826.augmentchoice.contenttest.valid.augmentedschvalid.TestedCont;
import com.airlenet.yang.gen.v1.augmentchoice.rev20160826.augmentchoice.contenttest.valid.augmentedschvalid.UnlistedVal;
import com.airlenet.yang.gen.v1.modeldatatoresourcedata.rev20160826.modeldatatoresourcedata.BinaryTypedef;
import com.airlenet.yang.gen.v1.modeldatatoresourcedata.rev20160826.modeldatatoresourcedata.DefaultFirstLevel;
import com.airlenet.yang.gen.v1.modeldatatoresourcedata.rev20160826.modeldatatoresourcedata.UnionTypedef;
import com.airlenet.yang.gen.v1.modeldatatoresourcedata.rev20160826.modeldatatoresourcedata.Uri;
import com.airlenet.yang.gen.v1.modeldatatoresourcedata.rev20160826.modeldatatoresourcedata.firstlevel.DefaultContainerChoice;
import com.airlenet.yang.gen.v1.modeldatatoresourcedata.rev20160826.modeldatatoresourcedata.firstlevel.DefaultContainerGrouping;
import com.airlenet.yang.gen.v1.modeldatatoresourcedata.rev20160826.modeldatatoresourcedata.firstlevel.DefaultContainerLeaf;
import com.airlenet.yang.gen.v1.modeldatatoresourcedata.rev20160826.modeldatatoresourcedata.firstlevel.DefaultContainerLeafList;
import com.airlenet.yang.gen.v1.modeldatatoresourcedata.rev20160826.modeldatatoresourcedata.firstlevel.DefaultContainerList;
import com.airlenet.yang.gen.v1.modeldatatoresourcedata.rev20160826.modeldatatoresourcedata.firstlevel.DefaultOnlyContainer;
import com.airlenet.yang.gen.v1.modeldatatoresourcedata.rev20160826.modeldatatoresourcedata.firstlevel.containerchoice.choicecase.DefaultLeafCase;
import com.airlenet.yang.gen.v1.modeldatatoresourcedata.rev20160826.modeldatatoresourcedata.firstlevel.containerchoice.choicecase.leafcase.DefaultAugmentedLeafCase;
import com.airlenet.yang.gen.v1.modeldatatoresourcedata.rev20160826.modeldatatoresourcedata.firstlevel.containerleaf.DefaultAugmentedContainerLeaf;
import com.airlenet.yang.gen.v1.modeldatatoresourcedata.rev20160826.modeldatatoresourcedata.firstlevel.containerleaflist.LeafList2Enum;
import com.airlenet.yang.gen.v1.modeldatatoresourcedata.rev20160826.modeldatatoresourcedata.firstlevel.containerlist.DefaultListLeaf;
import com.airlenet.yang.gen.v1.modeldatatoresourcedata.rev20160826.modeldatatoresourcedata.firstlevel.containerlist.ListLeaf;
import com.airlenet.yang.gen.v1.modeldatatoresourcedata.rev20160826.modeldatatoresourcedata.firstlevel.containerlist.ListLeafKeys;
import com.airlenet.yang.gen.v1.modeldatatoresourcedata.rev20160826.modeldatatoresourcedata.firstlevel.containerlist.listleaf.DefaultAugmentedListLeaf;
import com.airlenet.yang.gen.v1.modeldatatoresourcedata.rev20160826.modeldatatoresourcedata.group1.DefaultGroupContainer;
import com.airlenet.yang.gen.v1.modeldatatoresourcedatainterfile.rev20160826.modeldatatoresourcedatainterfile.firstlevel.containerchoice.choicecase.augmentedschchoicecase.DefaultLeafInterAug;
import com.airlenet.yang.gen.v1.modeldatatoresourcedatainterfile.rev20160826.modeldatatoresourcedatainterfile.firstlevel.containerchoice.choicecase.leafcase.DefaultAugmentedSchLeafCase;
import com.airlenet.yang.gen.v1.modulelistandkey.rev20160826.modulelistandkey.DefaultModKey;
import com.airlenet.yang.gen.v1.modulelistandkeyaugment.rev20160826.modulelistandkeyaugment.modkey.DefaultAugmentedSchModKey;
import com.airlenet.yang.gen.v1.modulelistandkeyaugment.rev20160826.modulelistandkeyaugment.modkey.augmentedschmodkey.AugListModKey;
import com.airlenet.yang.gen.v1.modulelistandkeyaugment.rev20160826.modulelistandkeyaugment.modkey.augmentedschmodkey.DefaultAugListModKey;
import com.airlenet.yang.gen.v1.ytbchoicewithcontainerandleaflist.rev20160826.ytbchoicewithcontainerandleaflist.contenttest.DefaultValid;
import com.airlenet.yang.gen.v1.ytbchoicewithcontainerandleaflist.rev20160826.ytbchoicewithcontainerandleaflist.contenttest.Valid;
import com.airlenet.yang.gen.v1.ytbchoicewithcontainerandleaflist.rev20160826.ytbchoicewithcontainerandleaflist.contenttest.choicecontainer.ChoiceContainer;
import com.airlenet.yang.gen.v1.ytbchoicewithcontainerandleaflist.rev20160826.ytbchoicewithcontainerandleaflist.contenttest.choicecontainer.DefaultChoiceContainer;
import com.airlenet.yang.gen.v1.ytbchoicewithcontainerandleaflist.rev20160826.ytbchoicewithcontainerandleaflist.contenttest.choicecontainer.choicecontainer.DefaultPredict;
import com.airlenet.yang.gen.v1.ytbchoicewithcontainerandleaflist.rev20160826.ytbchoicewithcontainerandleaflist.contenttest.choicecontainer.choicecontainer.Predict;
import com.airlenet.yang.gen.v1.ytbchoicewithcontainerandleaflist.rev20160826.ytbchoicewithcontainerandleaflist.contenttest.choicecontainer.choicecontainer.predict.DefaultReproduce;
import com.airlenet.yang.gen.v1.ytbchoicewithcontainerandleaflist.rev20160826.ytbchoicewithcontainerandleaflist.contenttest.choicecontainer.choicecontainer.predict.Reproduce;
import com.airlenet.yang.gen.v1.ytbchoicewithcontainerandleaflist.rev20160826.ytbchoicewithcontainerandleaflist.currentvalue.DefaultYtbAbsent;
import com.airlenet.yang.gen.v1.ytbsimpleaugment.rev20160826.ytbsimpleaugment.DefaultCont1;
import com.airlenet.yang.gen.v1.ytbsimpleaugment.rev20160826.ytbsimpleaugment.cont1.DefaultCont2;
import com.airlenet.yang.gen.v1.ytbsimpleaugment.rev20160826.ytbsimpleaugment.cont1.cont2.DefaultAugmentedCont2;
import com.airlenet.yang.gen.v1.ytbsimpleaugment.rev20160826.ytbsimpleaugment.cont1.cont2.augmentedcont2.Cont1s;
import com.airlenet.yang.gen.v1.ytbsimpleaugment.rev20160826.ytbsimpleaugment.cont1.cont2.augmentedcont2.DefaultCont1s;
import com.airlenet.yang.gen.v1.ytbsimplechoicecase.rev20160826.ytbsimplechoicecase.DefaultYtbFood;
import com.airlenet.yang.gen.v1.ytbsimplechoicecase.rev20160826.ytbsimplechoicecase.ytbfood.ytbsnack.DefaultYtbLateNight;
...
public class DataTreeContextSwitchTest {
    ...
    public void processSimpleChoiceCase() {
        ...
        TestUtils.validateDataNode(node, "YtbFood", nameSpace, SINGLE_INSTANCE_NODE,
                         true, null);
        ...
        TestUtils.validateDataNode(n.getValue(), "chocolate", nameSpace,
    ...
    public void processSimpleChoiceCaseModIdOne() {
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "chocolate", nameSpace,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE,
                         true, CHOC);
    }
    ...
    public void processChoiceWithNodeAndLeafList() {
        ...
        // Case container is added to the choice content-test.
        com.airlenet.yang.gen.v1.ytbchoicewithcontainerandleaflist.rev20160826
                .ytbchoicewithcontainerandleaflist.contenttest
                .DefaultChoiceContainer contentTest =
                new com.airlenet.yang.gen.v1.ytbchoicewithcontainerandleaflist
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "choice-container", nameSpace,
        ...
        Map.Entry<NodeKey, DataNode> n = it.next();
        TestUtils.validateDataNode(n.getValue(), "predict", nameSpace,
                         MULTI_INSTANCE_NODE,
                         true, null);
        ...
        n = it.next();
        TestUtils.validateDataNode(n.getValue(), "reproduce", nameSpace,
                         SINGLE_INSTANCE_NODE,
                         true, null);
        ...
        it = child.entrySet().iterator();
        n = it.next();
        TestUtils.validateDataNode(n.getValue(), "catch", nameSpace,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE,
                         true, "100");

        node = dataNodes.get(1);
        TestUtils.validateDataNode(node, "final", nameSpace,
    ...
    public void processSimpleAugment() {
        ...
        com.airlenet.yang.gen.v1.ytbsimpleaugment.rev20160826
                .ytbsimpleaugment.cont1.cont2.augmentedcont2.cont1s
                .Cont1s cont1s1 = new com.airlenet.yang.gen.v1.ytbsimpleaugment
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "cont1", nameSpace,
                         SINGLE_INSTANCE_NODE,
                         true, null);
        //Here only one instance of list will be added because config is
        // false. so there will be no difference in 2 instance of list node.
        ...
        Map.Entry<NodeKey, DataNode> n = it.next();
        TestUtils.validateDataNode(n.getValue(), "cont2", nameSpace,
                         SINGLE_INSTANCE_NODE,
                         true, null);
        child = ((InnerNode) n.getValue()).childNodes();
        ...
        it = child.entrySet().iterator();
        n = it.next();
        TestUtils.validateDataNode(n.getValue(), "leaf4", nameSpace,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE,
                         true, "500");

        n = it.next();
        TestUtils.validateDataNode(n.getValue(), "cont1s", nameSpace,
                         SINGLE_INSTANCE_NODE,
                         true, null);
    ...
    public void processSimpleAugmentModIdC1() {
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "cont2", nameSpace,
                         SINGLE_INSTANCE_NODE,
                         true, null);
        //Here only one instance of list will be added because config is
        // false. so there will be no difference in 2 instance of list node.
    ...
    public void processSimpleAugmentModIdC2() {
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "leaf4", nameSpace,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE,
                         true, "500");

        node = dataNodes.get(1);
        TestUtils.validateDataNode(node, "cont1s", nameSpace,
                         SINGLE_INSTANCE_NODE,
                         true, null);
    }
    ...
    public void processSimpleAugmentModIdAug() {
        ...
        com.airlenet.yang.gen.v1.ytbsimpleaugment.rev20160826
                .ytbsimpleaugment.cont1.cont2.augmentedcont2.cont1s
                .DefaultCont1s cont1s1 = new com.airlenet.yang.gen.v1.ytbsimpleaugment
                .rev20160826.ytbsimpleaugment.cont1.cont2
                .augmentedcont2.cont1s.DefaultCont1s();
    ...
    public void processInterFileAugmentList() {
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "modKey", nameSpace,
                         MULTI_INSTANCE_NODE,
                         true, null);
        ...
        TestUtils.validateDataNode(n.getValue(), "types", nameSpace,
                         ...
                         true, "20");
        n = it.next();
        TestUtils.validateDataNode(n.getValue(), "aug-list-modKey", nameSpace,
                         MULTI_INSTANCE_NODE,
                         true, null);
    }
    ...
    public void moduleWithModIdFirstLvlOne() {
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "only-container", nameSpace,
                         SINGLE_INSTANCE_NODE,
                         true, null);
    ...
    public void moduleWithModIdFirstLvlTwo() {
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "container-leaf", nameSpace,
                         SINGLE_INSTANCE_NODE,
                         true, null);
        ...
        Map.Entry<NodeKey, DataNode> n = it.next();
        TestUtils.validateDataNode(n.getValue(), "leaf2", nameSpace,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE,
                         true, "leaf2");
        n = it.next();
        TestUtils.validateDataNode(n.getValue(), "leaf-aug", nameSpace,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE,
                         true, null);
    }
    ...
    public void moduleWithModIdFirstLvlThree() {
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "container-leaf-list", nameSpace,
                         SINGLE_INSTANCE_NODE,
                         true, null);
        ...
        Map.Entry<NodeKey, DataNode> n = it.next();
        TestUtils.validateDataNode(n.getValue(), "leaf-list2", nameSpace,
                         MULTI_INSTANCE_LEAF_VALUE_NODE,
                         true, "hundred");
        n = it.next();
        TestUtils.validateDataNode(n.getValue(), "leaf-list2", nameSpace,
    ...
    public void moduleWithModIdFirstLvlFour() {
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "container-list", nameSpace,
                         SINGLE_INSTANCE_NODE,
                         true, null);
        ...
        Map.Entry<NodeKey, DataNode> n = it.next();
        TestUtils.validateDataNode(n.getValue(), "list-leaf", nameSpace,
                         MULTI_INSTANCE_NODE,
                         true, null);
        child = ((InnerNode) n.getValue()).childNodes();
        assertThat(2, is(child.size()));
        ...
        it = child.entrySet().iterator();
        n = it.next();
        TestUtils.validateDataNode(n.getValue(), "name", nameSpace,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE,
                         true, "first");
        n = it.next();
        TestUtils.validateDataNode(n.getValue(), "leaf-aug", nameSpace,
    ...
    public void moduleWithModIdFirstLvlFourL2() {
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "list-leaf", nameSpace,
                         MULTI_INSTANCE_NODE,
                         true, null);
    ...
    public void moduleWithModIdFirstLvlFive() {
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "container-choice", nameSpace,
                         SINGLE_INSTANCE_NODE,
                         true, null);
        ...
        Map.Entry<NodeKey, DataNode> n = it.next();
        TestUtils.validateDataNode(n.getValue(), "leaf3", nameSpace,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE,
                         true, "120");
        n = it.next();
        TestUtils.validateDataNode(n.getValue(), "leaf-aug", nameSpace,
                         ...
                         true, "MTAxMQ==");
        n = it.next();
        TestUtils.validateDataNode(n.getValue(), "leaf-inter-aug", nameSpace,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE,
                         true, "21102");
    }
    ...
    public void moduleWithModIdFirstLvlSeven() {
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "container-grouping", nameSpace,
                         SINGLE_INSTANCE_NODE,
                         true, null);
        ...
        Map.Entry<NodeKey, DataNode> n = it.next();
        TestUtils.validateDataNode(n.getValue(), "group-container", nameSpace,
                         SINGLE_INSTANCE_NODE,
                         true, null);
        ...
        n = it.next();
        TestUtils.validateDataNode(n.getValue(), "group-leaf", nameSpace,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE,
                         true, "namespace");
    }
    ...
    public void processMultiAugWithSameName() {
        ...
        node = dataNodes.get(0);
        TestUtils.validateDataNode(node, "ch-test", nameSpace,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE, true, "private-ip");

        node = dataNodes.get(1);
        TestUtils.validateDataNode(node, "test", nameSpace,
        ...
        TestUtils.validateDataNode(node, "unlisted-val", nameSpace, MULTI_INSTANCE_NODE,
                         true, null);
        ...
        Iterator<Map.Entry<NodeKey, DataNode>> it = child.entrySet().iterator();
        Map.Entry<NodeKey, DataNode> n = it.next();
        TestUtils.validateDataNode(n.getValue(), "presence", nameSpace,
                         SINGLE_INSTANCE_LEAF_VALUE_NODE, true, "false");

        node = dataNodes.get(4);
        TestUtils.validateDataNode(node, "aug-case-modKey", nameSpace,
        ...
        TestUtils.validateDataNode(node, "tested-cont", nameSpace, SINGLE_INSTANCE_NODE,
                         true, null);
...
//                new com.airlenet.yang.gen.v1.yms.test.ytb.choice.with
