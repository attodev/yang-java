...
import com.airlenet.yang.gen.v1.simpledatatypesll.rev20131112.simpledatatypesll.DefaultCont1;
import com.airlenet.yang.gen.v1.simpledatatypesll.rev20131112.simpledatatypesll.cont1.Lfenum2Enum;
import com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826.ytbdatatypes.Leaf7;
import com.airlenet.yang.model.DataNode;
import com.airlenet.yang.model.DataNode.Builder;
...
import static com.airlenet.yang.gen.v1.simpledatatypesll.rev20131112.simpledatatypesll.cont1.Lfenum1Enum.GRACE_PERIOD_EXPIRED;
...
public class YobSimpleDataTypeTest {
    ...
    public static void validateDataNodeForSimpleDataTypes(DataNode node) {
        DataNode n = node;
        TestUtils.validateDataNode(n, "cont", DT_NS, SINGLE_INSTANCE_NODE,
                         true, null);
        Iterator<DataNode> it3 = ((InnerNode) n).childNodes().values()
                .iterator();
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnint8Min", DT_NS, INT8, "-128", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnint8Max", DT_NS, INT8, "127", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnint16Min", DT_NS, INT16, "-32768", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnint16Max", DT_NS, INT16, "32767", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnint32Min", DT_NS, INT32, "-2147483648", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnint32Max", DT_NS, INT32, "2147483647", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnint64Min", DT_NS, INT64, "10090", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnint64Max", DT_NS, INT64, "100700", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnuint8Max", DT_NS, UINT8, "255", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnuint16Max", DT_NS, UINT16, "65535", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnuint32Max", DT_NS, UINT32, "10000", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfuint64Max", DT_NS, UINT64, "32656256558", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfstr", DT_NS, STRING, "string1", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfstr1", DT_NS, STRING, "string2", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfbool1", DT_NS, BOOLEAN, "true", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfbool2", DT_NS, BOOLEAN, "false", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfbool3", DT_NS, BOOLEAN, "false", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfdecimal1", DT_NS, DECIMAL64,
                         "-922337203685477580.8", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfdecimal2", DT_NS, DECIMAL64,
                         "-92233720368547758.08", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfdecimal3", DT_NS, DECIMAL64,
                         "-9223372036854775.808", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfdecimal4", DT_NS, DECIMAL64,
                         "-922337203685477.5808", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfdecimal6", DT_NS, DECIMAL64,
                         "-9223372036854.775808", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfenum", DT_NS, ENUMERATION, "3.3ms", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfbits", DT_NS, BITS, "bit1", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfbinary", DT_NS, BINARY, "aGV5", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfref1", DT_NS, STRING, "path", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfref2", DT_NS, INT8, "100", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfempty", DT_NS, EMPTY, null, true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion1", DT_NS, STRING, "cost", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion2", DT_NS, DECIMAL64,
                         "-92233720368547758.08", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion4", DT_NS, BOOLEAN, "true", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion5", DT_NS, STRING, "color", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion7", DT_NS, BITS, "b1", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion8", DT_NS, STRING, "bandwidth", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion9", DT_NS, UINT16, "200", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion10", DT_NS, BOOLEAN, "true", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion11", DT_NS, BITS, "b1", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion12", DT_NS, EMPTY, "true", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion13", DT_NS, BITS, "b2", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion14", DT_NS, ENUMERATION, "one", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "identityref1", DT_NS, IDENTITYREF, "iden", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "identityref2", DT_NS, IDENTITYREF, "pro", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfenum1", DT_NS, ENUMERATION, "successful exit", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfenum2", DT_NS, ENUMERATION, "*", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "inst-iden", DT_NS, INSTANCE_IDENTIFIER, "/cont", true);
        validateLeafRef(it3);
    }
    ...
    static void validateLeafRef(Iterator<DataNode> it3) {
        ...
        DataNode n = it3.next();
        TestUtils.validateDataNode(n, "lref1", DT_NS, INT8, "8", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lref2", DT_NS, IDENTITYREF, "val", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lref3", DT_NS, ENUMERATION, "zero", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lref4", DT_NS, BITS, "b2 b3", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lref5", DT_NS, DECIMAL64, "-92233720368547758.08",
                         true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lref6", DT_NS, INT8, "10", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lref7", DT_NS, ENUMERATION, "enum4", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lref8", DT_NS, DECIMAL64, "-9223372036854.775808",
                         true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lref9", DT_NS, BINARY, "MTAxMDEwMTAx", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lref10", DT_NS, EMPTY, null, true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lref11", DT_NS, EMPTY, null, true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lref12", DT_NS, BITS, "b3", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lref13", DT_NS, EMPTY, null, true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lref14", DT_NS, BITS, "b1 b2 b3", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lref15", DT_NS, INSTANCE_IDENTIFIER, "/cont", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lref16", DT_NS, IDENTITYREF, "physical", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lref17", DT_NS, UINT64, "784985", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lref18", DT_NS, BINARY, "MTExMTExMTE=", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lref19", DT_NS, ENUMERATION, "hundred", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "lref20", DT_NS, STRING, "leafref", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "iref1", DT_NS, IDENTITYREF, "val", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "iref3", DT_NS, IDENTITYREF, "physical", true);
        n = it3.next();
        TestUtils.validateDataNode(n, "iref2", DT_NS, IDENTITYREF, "pro", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "iref4", DT_NS, IDENTITYREF, "virtual", false);
    }
    ...
    private void validateLeafListDataTypes(DataNode node) {
        DataNode n = node;
        TestUtils.validateDataNode(n, "cont1", DT_LL, SINGLE_INSTANCE_NODE,
                         true, null);
        Iterator<DataNode> it3 = ((InnerNode) n).childNodes().values()
                .iterator();
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnint8Min", DT_LL, INT8, "-128", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnint8Max", DT_LL, INT8, "127", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnint16Min", DT_LL, INT16, "-32768", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnint16Max", DT_LL, INT16, "32767", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnint32Min", DT_LL, INT32, "-2147483648", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnint32Max", DT_LL, INT32, "2147483647", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnint64Min", DT_LL, INT64, "10090", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnint64Max", DT_LL, INT64, "100700", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnuint8Max", DT_LL, UINT8, "255", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnuint16Max", DT_LL, UINT16, "65535", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfnuint32Max", DT_LL, UINT32, "10000", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfuint64Max", DT_LL, UINT64, "32656256558", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfstr", DT_LL, STRING, "string1", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfstr1", DT_LL, STRING, "string2", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfbool1", DT_LL, BOOLEAN, "true", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfbool2", DT_LL, BOOLEAN, "false", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfbool3", DT_LL, BOOLEAN, "false", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfdecimal1", DT_LL, DECIMAL64,
                         "-922337203685477580.8", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfdecimal2", DT_LL, DECIMAL64,
                         "-92233720368547758.08", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfdecimal3", DT_LL, DECIMAL64,
                         "-9223372036854775.808", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfdecimal4", DT_LL, DECIMAL64,
                         "-922337203685477.5808", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfdecimal6", DT_LL, DECIMAL64,
                         "-9223372036854.775808", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfenum", DT_LL, ENUMERATION, "enum1", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfbits", DT_LL, BITS, "bit1", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfbinary", DT_LL, BINARY, "aGVsbG8=", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfref1", DT_LL, STRING, "path", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfref2", DT_LL, INT8, "100", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfempty", DT_LL, EMPTY, null, false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion1", DT_LL, STRING, "cost", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion2", DT_LL, DECIMAL64,
                         "-92233720368547758.08", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion4", DT_LL, BOOLEAN, "true", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion5", DT_LL, STRING, "color", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion7", DT_LL, BITS, "b1", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion8", DT_LL, STRING, "bandwidth", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion9", DT_LL, UINT16, "200", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion10", DT_LL, BOOLEAN, "true", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion11", DT_LL, BITS, "b1", false);
        n = it3.next();
        // need to be handled later
        TestUtils.validateDataNode(n, "lfunion12", DT_LL, EMPTY, "true", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion13", DT_LL, BITS, "b2", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfunion14", DT_LL, ENUMERATION, "one", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "identityref1", DT_LL, IDENTITYREF, "iden", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfenum1", DT_LL, ENUMERATION,
                         "grace period expired", false);
        n = it3.next();
        TestUtils.validateDataNode(n, "lfenum2", DT_LL, ENUMERATION, "*", false);
    }
    ...
    public void allDataTypesTest() {
        ...
        assertThat(cont.lref2().toString(), is(
                "class com.airlenet.yang.gen.v1.simpledatatypes" +
        ...
        assertThat(cont.lref16().toString(), is(
                "class com.airlenet.yang.gen.v1.ytbdatatypes.rev20160826." +
        ...
        assertThat(cont.iref1().toString(), is(
                "class com.airlenet.yang.gen.v1.simpledatatypes.rev201311" +
